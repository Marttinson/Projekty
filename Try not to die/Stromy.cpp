...
void Stromy::zvetseniPole() {
	...
	this->prvek = new Strom[this->velikost_pole];
	for (int i = 0; i < this->pocet_prvku; i++) {
		this->prvek[i].nastaveniStromu();
...
bool Stromy::kontrola(sf::Vector2f souradnice) {
...
void Stromy::render(sf::RenderTarget* okno) {
	for (int i = 0; i < this->pocet_prvku; i++) {
